...
def main():
    ...
    feature = a.feature or "days_to_cover"
    if a.hold:
        # explicit --hold: run exactly that horizon (this is what the user asked for)
        run_one(px,pos_of,si_db,feature,a.hold,a.min_names,a.clip_dtc)
    elif a.feature:
        # feature given, no hold -> default 40
        run_one(px,pos_of,si_db,feature,40,a.min_names,a.clip_dtc)
    else:
        # nothing specified -> demo the two validated horizons
        for h in (40,20):
