...
if st.button("Run Strategy"):
    ...
    # Send email alert if signal and confidence high
    ...
    if latest['Signal'] == 1 and latest['Prob'] > 0.7:
        ...
        # Optional Alpaca trading
        if enable_trading:
            alpaca = tradeapi.REST(os.getenv("ALPACA_KEY"), os.getenv("ALPACA_SECRET"), os.getenv("ALPACA_URL"))
            try:
